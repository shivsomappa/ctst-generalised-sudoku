...
int find_CTS_dsc(Grid2D& temp_1,Grid2D& temp_2,int list_end,int size,int &c_count,int max_set_size);
int sort_temp_1_data_dsc(Grid2D& temp_1,int &size,int max_set_size);


int filter_symbol_hrz_dsc(Grid3D& p_OT, Grid2D& temp_1,Grid2D& temp_2,int x,int size,int max_set_size, int pid, int stat_data[]);
int filter_symbol_vrt_dsc(Grid3D& p_OT, Grid2D& temp_1,Grid2D& temp_2,int x,int size,int max_set_size, int pid, int stat_data[]);
int filter_symbol_blk_dsc(Grid3D& p_OT, Grid2D& temp_1,Grid2D& temp_2,int bx,int by,int blk_size,int size,int max_set_size, int pid, int stat_data[]);

int find_n_symbol_n_cell_tally_dsc(Grid3D& p_OT, Grid2D& temp_1, Grid2D& temp_2,int size,int blk_size,int max_set_size, int pid, int stat_data[])
{
	int i=0,j=0, flag=0;
	...
	while(i<size&&flag==0)
	{
		flag=filter_symbol_hrz_dsc(p_OT,temp_1,temp_2,i,size,max_set_size, pid, stat_data);
		i++;
	}
	...
	if (flag == 0)
	{
		...
		while(i<size&&flag==0)
		{
			flag = filter_symbol_vrt_dsc(p_OT,temp_1, temp_2, i, size, max_set_size, pid, stat_data);
			i++;
		}
	}
	...
	if (flag == 0)
	{
		...
		while(i<size&&flag==0)
		{
			...
			while(j<size&&flag==0)
			{
				flag = filter_symbol_blk_dsc(p_OT, temp_1, temp_2, i, j, blk_size, size, max_set_size, pid, stat_data);
				j = j + blk_size;
			}
			i = i + blk_size;
		}
...
int filter_symbol_hrz_dsc(Grid3D& p_OT, Grid2D& temp_1,Grid2D& temp_2,int x,int size,int max_set_size, int pid, int stat_data[])
{
	...
	if(cc > 4 && flag==1)
	{
		...
		//***********************************************************************
		sort_temp_1_data_dsc(temp_1, list_end, max_set_size);

		if (list_end > 3)
		{
			flag = find_CTS_dsc(temp_1, temp_2, list_end, size, c_count, max_set_size);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
int filter_symbol_vrt_dsc(Grid3D& p_OT, Grid2D& temp_1,Grid2D& temp_2,int y,int size,int max_set_size, int pid, int stat_data[])
{
	int i=0,j=0,k=0, flag=0, list_end=0,cc=0,c_count,set_1=0;
	int x1, y1;
